...
## [0.18.2](https://github.com/niansahc/ember-2/compare/v0.18.1...v0.18.2) (2026-09-26)
...
* **observability:** hit counters on retrieval and scoring guards ([ca3e59d](https://github.com/niansahc/ember-2/commit/ca3e59d87bd1cfad2d39dc2c0cb5283fdd8b51a7))
* **observability:** hit counters on retrieval and scoring guards ([2dfd463](https://github.com/niansahc/ember-2/commit/2dfd463b0b54dc41b1de7c887a7b44a46cbbd706))
...
* reclassify prior-substrate conversation from ingested (ADR-015 amendment) ([351e348](https://github.com/niansahc/ember-2/commit/351e3486c3a5e7318637c4375f68db99cd58bd3c))
* reclassify prior-substrate conversation from ingested (ADR-015 amendment) ([63466b1](https://github.com/niansahc/ember-2/commit/63466b15c50075dc62d84a6004a6a16b1d928935))
...
* **scripts:** add memory.db rebuild path to rebuild_indexes ([b8dae3a](https://github.com/niansahc/ember-2/commit/b8dae3a0e6cb1895e95d3bee5a4d6bd4db7b7e08))
* **scripts:** add memory.db rebuild path to rebuild_indexes ([07053b8](https://github.com/niansahc/ember-2/commit/07053b8cc010f658ec5a1d20ed00ca8e7032961b))
* **tools:** Morris screening over retrieval scoring parameters ([d7427d0](https://github.com/niansahc/ember-2/commit/d7427d0ed8a9a2b17ee394b829c20919845e8238))
* **tools:** Morris screening over retrieval scoring parameters ([0bdc148](https://github.com/niansahc/ember-2/commit/0bdc148da6c013d12d4bc311ca95b70fd1c3fa99))
* **tools:** per-term retrieval trace capture for sensitivity analysis ([359a077](https://github.com/niansahc/ember-2/commit/359a07732a6c6246f4cbefdd6ebfd07d24c09c63))
* **tools:** per-term retrieval trace capture for sensitivity analysis ([8caf483](https://github.com/niansahc/ember-2/commit/8caf4836d366fd077073839b9dddf1a6447c8c2d))
* **tools:** Sobol sensitivity indices over retrieval scoring parameters ([73e239e](https://github.com/niansahc/ember-2/commit/73e239edadb3dd37ca6a6b05757f11025e2db764))
* **tools:** Sobol sensitivity indices over retrieval scoring parameters ([8cf1d2d](https://github.com/niansahc/ember-2/commit/8cf1d2d91aa890fef4d246ed1f5b0e902925099f))
...
* ANTHROPIC_API_KEY resolves from keyring before .env (closes [#189](https://github.com/niansahc/ember-2/issues/189)) ([741302a](https://github.com/niansahc/ember-2/commit/741302a805a406b6e4096582aac789e75b93cfc9))
* ANTHROPIC_API_KEY resolves from keyring before .env (closes [#189](https://github.com/niansahc/ember-2/issues/189)) ([c69cac8](https://github.com/niansahc/ember-2/commit/c69cac89258d873c6d53caca4ea322c7bf4e8955))
* auxiliary callers resolve a local-only model, independent of generation host ([10e0bc2](https://github.com/niansahc/ember-2/commit/10e0bc25f80046642616ec9da54a7032cac96012))
* auxiliary callers resolve a local-only model, independent of generation host ([#190](https://github.com/niansahc/ember-2/issues/190)) ([7481d24](https://github.com/niansahc/ember-2/commit/7481d2489cffb3eb6366873612206bc20055200a))
...
* **context:** add read-only path so debug-context does not mutate retrieval stats ([dcbb7ec](https://github.com/niansahc/ember-2/commit/dcbb7ec52a307e421cbcb4224018c19844f847e0))
* **context:** add read-only path so debug-context does not mutate retrieval stats ([085e4f7](https://github.com/niansahc/ember-2/commit/085e4f7a34de07217237f18609f0e06917aa0644)), closes [#206](https://github.com/niansahc/ember-2/issues/206)
* **context:** extend read-only coverage to all trace replay entry points ([9c0a6f6](https://github.com/niansahc/ember-2/commit/9c0a6f655d2435d4f1ea15761ac1e257321c76a0))
* **context:** extend read-only coverage to all trace replay entry points ([ee099f6](https://github.com/niansahc/ember-2/commit/ee099f6e473372a9b627936e5e8fe3c22730f785))
* **context:** stop charging profile records against the memory retrieval window ([afdb26f](https://github.com/niansahc/ember-2/commit/afdb26fabd65140277c7d662e3adc4a860ed6fa8))
* **context:** stop charging profile records against the memory retrieval window ([d028834](https://github.com/niansahc/ember-2/commit/d0288343596b9550de26a97f9500a8a241bf6f14))
* **context:** write retrieval stats only for records the model sees ([d9ac0f3](https://github.com/niansahc/ember-2/commit/d9ac0f31beacd4ef053d51a7528073114d03e158))
* **context:** write retrieval stats only for records the model sees ([bacd90e](https://github.com/niansahc/ember-2/commit/bacd90e6c9ae8129101895e742a2568a0d1523f2))
...
* **generation:** thread session_id through non-streaming path, fix buffer reset ([9686ca6](https://github.com/niansahc/ember-2/commit/9686ca625b03574a57763cfe714eaf9942845988))
* **generation:** thread session_id through non-streaming path, fix buffer reset ([3698453](https://github.com/niansahc/ember-2/commit/36984530887f189ae6711b900c687f29cd3c5099))
...
* **index:** close remaining memory.db drift and measure production cosine spread ([fce6d27](https://github.com/niansahc/ember-2/commit/fce6d27e26818ab58a1f603f36e65fbb2df7d075))
* **index:** close remaining memory.db drift and measure production cosine spread ([1aec89e](https://github.com/niansahc/ember-2/commit/1aec89eca9050889aaa065516e4641e699c50446))
* **index:** exclude eval_seed fixtures from live vault indexing ([e2fb5a6](https://github.com/niansahc/ember-2/commit/e2fb5a67408c15edf626aeaec1e3d55683b84241))
* **index:** exclude eval_seed fixtures from live vault indexing ([2309f3a](https://github.com/niansahc/ember-2/commit/2309f3a77cd830b88ad24d4792f0d9e258c79d42))
* isolate test environment from live .env configuration (closes [#195](https://github.com/niansahc/ember-2/issues/195)) ([15a9129](https://github.com/niansahc/ember-2/commit/15a91294db1530281fae60cc3077b68dfd095157))
* isolate test environment from live .env configuration (closes [#195](https://github.com/niansahc/ember-2/issues/195)) ([1034f10](https://github.com/niansahc/ember-2/commit/1034f10e107a6198a744c0ed03dafc8997ead24a))
* **memory:** recover collided records and make id collision non-silent ([6e4b6c3](https://github.com/niansahc/ember-2/commit/6e4b6c3726f0a144b96fcc3fd416953ba503c95c))
* **memory:** recover collided records and make id collision non-silent ([69b24d1](https://github.com/niansahc/ember-2/commit/69b24d181b1ea11e818fe975e912e3f611669a58)), closes [#210](https://github.com/niansahc/ember-2/issues/210)
* **privacy:** remove hardcoded user utterances from scoring triggers ([7cd10a5](https://github.com/niansahc/ember-2/commit/7cd10a55f41993ab4165ea7028f4d1c754d1e25d))
* **privacy:** remove hardcoded user utterances from scoring triggers ([1f46953](https://github.com/niansahc/ember-2/commit/1f46953b1cbcaa8907e726a9e0c75fb7a591404e))
* redact secrets from diagnostic output (closes [#188](https://github.com/niansahc/ember-2/issues/188)) ([5dc3f60](https://github.com/niansahc/ember-2/commit/5dc3f6014312225240842f165629d8fd9c85743b))
* redact secrets from diagnostic output (closes [#188](https://github.com/niansahc/ember-2/issues/188)) ([9ba3950](https://github.com/niansahc/ember-2/commit/9ba3950ca50cbb1abe2803ca3107981b8591e5db))
...
* **retrieval:** gate profile slots on min_score, closing the dead SQLite floor ([b520114](https://github.com/niansahc/ember-2/commit/b520114086e550839c777c26e6da94587b6ad373))
* **retrieval:** gate profile slots on min_score, closing the dead SQLite floor ([9b924f4](https://github.com/niansahc/ember-2/commit/9b924f449023cf5b90c0ce736934f246c9b44f39))
* **retrieval:** pass min_score on the main memory search path ([fccb608](https://github.com/niansahc/ember-2/commit/fccb6084a86d17ddb6063428c32e3fe74c334072))
* **retrieval:** pass min_score on the main memory search path ([736d87d](https://github.com/niansahc/ember-2/commit/736d87de7e2734b57075118d6ca99f9bb58a1393))
* **retrieval:** score reflections by cosine so the min_score gate applies ([62b3941](https://github.com/niansahc/ember-2/commit/62b394177260fbe5bcafbcf21258cfde7c7a15f6))
* **retrieval:** score reflections by cosine so the min_score gate applies ([95771db](https://github.com/niansahc/ember-2/commit/95771db7812331676da01184c14c69df2a873ed2))
* stop logging verbatim response text in safety reviews (closes [#151](https://github.com/niansahc/ember-2/issues/151)) ([60a11b9](https://github.com/niansahc/ember-2/commit/60a11b9e5465075447f8341a11bb8fc8a31c789c))
* stop logging verbatim response text in safety reviews (closes [#151](https://github.com/niansahc/ember-2/issues/151)) ([dfbde12](https://github.com/niansahc/ember-2/commit/dfbde1208bdcc3597be1181d905702b9f3f50526))
* **tiering:** rebuild tier distribution from corrected delivery signal ([a7f141b](https://github.com/niansahc/ember-2/commit/a7f141bcabb46da454530f3a1a7dd6e2e9ca781d))
* **tiering:** rebuild tier distribution from corrected delivery signal ([7beb71d](https://github.com/niansahc/ember-2/commit/7beb71df95050d0cf39bcc12fb2808dc498c8654))
* **tools:** pin the Sobol sampler instead of inferring it from the machine ([323dcfc](https://github.com/niansahc/ember-2/commit/323dcfc4aaeb2afced6e0f0b12f29a9eda89d8a4))
